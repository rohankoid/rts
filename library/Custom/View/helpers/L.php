<?php
class Custom_View_Helper_L extends Zend_View_Helper_Abstract
{
    public function l($text, $url, $options = array())
    {
         ...
         *  For best performance, we act only if a quick 
         *  strpos() pre-check gave a suspicion (because strip_tags() is expensive).
         *   
         */
